...
# 单轮训练/验证定义，是否反传由 optimizer is not None 决定
def run_one_epoch(
    model,
    loader,
    criterion,
...
def train(args):
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        if is_best:
            ...
            best_val_curb_iou = val_metrics["class_iou"][curb_class_id]  # 单独保存curb_iou
            save_checkpoint(
...
def parse_args():
    ...
    parser.add_argument("--num_points", type=int, default=16384)   # 16k
